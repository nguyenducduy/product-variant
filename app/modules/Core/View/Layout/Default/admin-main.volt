...
<html>
    ...
    <body class="fixed-header menu-pin">
        {% include '../../Core/View/Layout/Default/admin-sidebar.volt' %}
        <!-- START PAGE-CONTAINER -->
        <div class="page-container">
            {% include '../../Core/View/Layout/Default/admin-header.volt' %}
            <!-- START PAGE CONTENT WRAPPER -->
            <div class="page-content-wrapper">
                <!-- START PAGE CONTENT -->
                <div class="content">
                {% include '../../Core/View/Layout/Default/admin-jumpbotron.volt' %}
