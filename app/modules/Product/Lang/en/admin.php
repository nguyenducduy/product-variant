<?php
$messages = [
    'page-title-index' => 'Quản lý sản phẩm',
    'page-title-create' => 'Thêm sản phẩm',
    'page-title-edit' => 'Cập nhật sản phẩm',

    'title-index' => 'Sản phẩm',
    'title-listing' => 'Tất cả sản phẩm',
    'title-create' => 'Thêm',
    ...
    'th.vendorprice' => 'Giá vốn',
    'th.sellprice' => 'Giá bán',
    'td.edit' => 'Sửa',

    'form.category' => 'DM Sản phẩm',
    'form.name' => 'Tên',
    'form.vendorprice' => 'Giá vốn',
    'form.sellprice' => 'Giá bán',
    'form.discountpercent' => 'Giảm giá',
    'form.quantity' => 'Số lượng',
    'form.content' => 'Mô tả sản phẩm',
    'form.gallery' => 'Bộ sưu tập',
    'form.status' => 'Trạng thái',
    'form.barcode' => 'Mã SP',
    'form.variant' => 'Thêm thuộc tính',
    'form.button-submit' => 'Đồng ý',
    'form.button-clear' => 'Xoá',
    'form.seodescription' => 'SEO giói thiệu',
