                ...
                <div class="row">
                    <div class="col-sm-8">
                        ...
                        <?php echo $this->getContent(); ?>
                            <label class="col-sm-3 control-label"><?php echo $this->lang->query('form.name'); ?></label>
                            <div class="col-sm-9">
                                <input
                                    type="text"
                                    class="form-control"
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label"><?php echo $this->lang->query('form.email'); ?></label>
                            <div class="col-sm-9">
                                <?php if (isset($formData['email'])) { ?><?php echo $formData['email']; ?><?php } ?>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label"><?php echo $this->lang->query('form.password'); ?></label>
                            <div class="col-sm-9">
                                ********
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label"><?php echo $this->lang->query('form.status'); ?></label>
                            <div class="col-sm-9">
                                <select
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label"><?php echo $this->lang->query('form.role'); ?></label>
                            <div class="col-sm-9">
                                <select
                                    class="cs-select cs-skin-slide"
                                    data-init-plugin="cs-select"
                    ...
                    <div class="col-sm-8">
                        <div class="form-group">
                            <label class="col-sm-3 control-label">
                                <?php echo $this->lang->query('form.avatar'); ?>
                                <img class="edit-image" src="<?php echo $this->url->getStatic($formData['thumbnailImage']); ?>" alt="<?php echo $formData['thumbnailImage']; ?>" />
                            </label>
                            <div class="col-sm-9">
                        ...
                        <div class="row">
                            <div class="col-sm-3">
                            *: <?php echo $this->lang->query('default.required'); ?>
                            </div>
                            <div class="col-sm-9">
