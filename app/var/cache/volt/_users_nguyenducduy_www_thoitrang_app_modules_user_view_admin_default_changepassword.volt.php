...
<html>
    <head>
        ...
        <meta charset="utf-8" />
        <title>
    <?php echo $this->lang->query('page-title-changepassword'); ?> | <?php echo $this->config->global->title; ?>
</title>
                ...
                <div class="row">
                    <div class="col-sm-8">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label"><?php echo $this->lang->query('form.new-password'); ?></label>
                            <div class="col-sm-9">
                                <input
                                    type="password"
                                    class="form-control"
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label"><?php echo $this->lang->query('form.repeat-new-password'); ?></label>
                            <div class="col-sm-9">
                                <input
                                    type="password"
                                    class="form-control"
