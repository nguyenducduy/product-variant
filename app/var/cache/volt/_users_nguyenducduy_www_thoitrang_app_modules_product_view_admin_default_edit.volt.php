...
<html>
    <head>
        ...
        <meta charset="utf-8" />
        <title>
    <?php echo $this->lang->query('page-title-edit'); ?> | <?php echo $this->config->global->title; ?>
</title>
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-sm-8">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label">
                                <?php echo $this->lang->query('form.category'); ?>
                                <span class="required">*</span>
                            </label>
                            <div class="col-sm-9">
                                <select
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label">
                                <?php echo $this->lang->query('form.barcode'); ?>
                                <span class="required">*</span>
                            </label>
                            <div class="col-sm-9">
                                <input
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label">
                                <?php echo $this->lang->query('form.vendorprice'); ?>
                            </label>
                            <div class="col-sm-9">
                                <input
                                    type="text"
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label">
                                <?php echo $this->lang->query('form.sellprice'); ?>
                            </label>
                            <div class="col-sm-9">
                                <input
                                    type="text"
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label">
                                <?php echo $this->lang->query('form.discountpercent'); ?>
                            </label>
                            <div class="col-sm-9">
                                <input
                                    type="text"
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label">
                                <?php echo $this->lang->query('form.content'); ?>
                                <span class="required">*</span>
                            </label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label">
                                <?php echo $this->lang->query('form.seodescription'); ?>
                            </label>
                            <div class="col-sm-9">
                                <input
                                    type="text"
                                    ...
                                    placeholder=""
                                    name="seodescription"
                                    value="<?php if (isset($formData['seodescription'])) { ?><?php echo $formData['seodescription']; ?><?php } ?>"
                                     />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">
                                <?php echo $this->lang->query('form.seokeyword'); ?>
                            </label>
                            <div class="col-sm-9">
                                <input
                                    type="text"
                                    ...
                                    placeholder=""
                                    name="seokeyword"
                                    value="<?php if (isset($formData['seokeyword'])) { ?><?php echo $formData['seokeyword']; ?><?php } ?>"
                                     />
                            </div>
                        </div>
                        <div class="form-group">
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-sm-8">
                        <div class="form-group">
                            <label class="col-sm-3 control-label">
                                <?php echo $this->lang->query('form.cover'); ?>
                                <img id="<?php echo $id; ?>"  class="edit-image" src="<?php echo $this->url->getStatic($formData['thumbnailImage']); ?>" alt="<?php echo $this->url->getStatic('uploads' . $formData['image']); ?>" />
                                Medium: 340 x 434 <br/>
                                Thumb: 190 x 242
                            </label>
                            <div class="col-sm-9">
                        ...
                        <br>
                        <div class="form-group">
                            <label class="col-sm-3 control-label"><?php echo $this->lang->query('form.gallery'); ?></label>
                            <div class="col-sm-9">
...
<script type="text/javascript">
    var imageList = `<?php echo $formData['imageList']; ?>`;
</script>
...
<!-- END PAGE CONTENT WRAPPER -->
    ...
    <script data-preload="true" data-path="<?php echo $this->url->getStatic('plugins/pixie'); ?>" src="<?php echo $this->url->getStatic('plugins/pixie/pixie-integrate.js'); ?>"></script>
    <script>
        var productId = 0;
