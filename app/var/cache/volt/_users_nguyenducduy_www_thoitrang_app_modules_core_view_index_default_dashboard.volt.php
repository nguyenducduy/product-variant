...
<html>
    <head>
        ...
        <meta charset="utf-8" />
        <title>
    <?php echo $this->lang->query('page-title-dashboard'); ?> | <?php echo $this->config->global->title; ?>
</title>
            ...
            <div class="col-md-8">
              <div class="panel panel-transparent">
                <div class="panel-heading">
                  <div class="panel-title"><?php echo $this->lang->query('panel-title-overview'); ?>
                  </div>
                </div>
                <div class="panel-body">
                  <p>
                      <ul>
                          <li>Server: <?php echo $this->request->getServerAddress(); ?></li>
                          <li>Client: <?php echo $this->request->getClientAddress(); ?></li>
                          <li>Charset: <?php echo $this->request->getBestCharset(); ?></li>
                          <li>Language: <?php echo $this->request->getBestLanguage(); ?></li>
                          <li>User Agent: <?php echo $this->request->getUserAgent(); ?></li>
                      </ul>
