...
<html>
    ...
    <link href="<?php echo $this->url->getStatic('min/index.php?g=cssDefaultUserAdmin&rev=' . $this->config->global->version->css); ?>" rel="stylesheet" type="text/css">
    ...
    <div class="panel panel-transparent">
        <div class="panel-heading">
            <div class="btn-group pull-right m-b-10">
                  <a href="<?php echo $this->url->get('admin/user/create'); ?>" class="btn btn-complete"><i class="fa fa-plus"></i>&nbsp; <?php echo $this->lang->query('default.button-create'); ?></a>
                </div>
            <div class="clearfix"></div>
        </div>
                ...
                <table class="table table-hover table-condensed" id="basicTable">
                    <thead>
                        <tr>
                            ...
                            <th style="width:10%">
                                <a href="<?php echo $this->url->getBaseUri(); ?>admin/user?orderby=id&ordertype=<?php if (Phalcon\Text::lower($formData['orderType']) == 'desc') { ?>asc<?php } else { ?>desc<?php } ?><?php if ($formData['conditions']['keyword'] != '') { ?>&keyword=<?php echo $formData['conditions']['keyword']; ?><?php } ?>">
                                    ID
                                </a>
                            </th>
                            <th><?php echo $this->lang->query('th.name'); ?></th>
                            <th><?php echo $this->lang->query('th.email'); ?></th>
                            <th style="width:15%">
                    ...
                    <tbody>
                    <?php foreach ($myUsers->items as $item) { ?>
                        <tr>
                            ...
                            <td class="v-align-middle"><?php echo $item->id; ?></td>
                            <td class="v-align-middle">
                                <img src="<?php echo $this->url->getStatic($item->getThumbnailImage()); ?>" class="img-rounded" alt="<?php echo $item->getThumbnailImage(); ?>" width="50" height="50">
                                &nbsp; <?php echo $item->name; ?> <br/>
                                <small class="user-role"><?php echo $item->getRoleName(); ?></small>
                            </td>
                            <td class="v-align-middle"><?php echo $item->email; ?></td>
                            ...
                            <td class="v-align-middle">
                                <div class="btn-group btn-group-xs pull-right">
                                    <a href="<?php echo $this->url->get('admin/user/edit/' . $item->id); ?>" class="btn btn-default"><i class="fa fa-pencil"></i>&nbsp; <?php echo $this->lang->query('td.edit'); ?></a>
                                    <a href="javascript:deleteConfirm('<?php echo $this->url->get('admin/user/delete/' . $item->id); ?>', '<?php echo $item->id; ?>');" class="btn btn-danger"><i class="fa fa-trash-o"></i></a>
                                </div>
                            </td>
                        </tr>
                    <?php } ?>
...
<!-- END PAGE CONTENT WRAPPER -->
    ...
    <script type="text/javascript" src="<?php echo $this->url->getStatic('min/index.php?g=jsDefaultUserAdmin&rev=' . $this->config->global->version->js); ?>"></script>
